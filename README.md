...
```
cd existing_repo
git remote add origin https://gitlab.com/fehime/bul_map_node_postgresql.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fehime/bul_map_node_postgresql/-/settings/integrations)
